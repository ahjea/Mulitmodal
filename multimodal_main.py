...
def main():
    ...
    for i, (train_idx, test_idx) in enumerate(splits):
        ...
        # train_dataloader_url = data_loader.create_dataloader(train_inputs_url, train_attention_mask_url, train_labels_url, True, 16)
        # validation_dataloader_url = data_loader.create_dataloader(val_inputs_url, val_attention_mask_url, val_labels_url, True, 16)
        # prediction_dataloader_url = data_loader.create_dataloader(test_inputs_url, test_attention_mask_url, test_labels_url, False, 16)
        ...
        train_loss_history, val_loss_history, acc_history, test_acc, f1, recall, precision, confusion = models.dual_model_train(train_dataloader, validation_dataloader, prediction_dataloader, 100, device, i+1)
        print("====================Train Result====================")
